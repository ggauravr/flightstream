...
import FlightServer from '../arrow-flight-server/core/flight-server.js';
import CSVFlightService from '../arrow-flight-server/adapters/csv-adapter.js';
...
async function main() {
  console.log('🏗️  Initializing Arrow Flight Server (Restructured)...');
  ...
  console.log(`   Proto Path: ${config.server.protoPath}`);
